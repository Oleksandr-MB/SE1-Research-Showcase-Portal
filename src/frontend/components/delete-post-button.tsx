 ...
 * 
 * A button component that allows post owners to delete their posts.
 * Only visible to the user who created the post.
 * Shows a confirmation dialog before deletion with the text:
 * "Are you sure you want to delete this post?"
 * 
 * @param postId - The ID of the post to delete
 * @param isOwner - Whether the current user owns the post
 * @param onDeleted - Optional callback after successful deletion
 */
export default function DeletePostButton({ postId, isOwner, onDeleted }: Props) {
